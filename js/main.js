...
(function($){
    ...
    window.theme = {
        ...
        loadThemeVersion: function(){
            ...
            $.getJSON(`${theme.themePath}js/version.json?t=${Date.now()}`, function(data){
            ...
            setTimeout(() => {
                $("#form-comments .submit-review").on("click", function(e){
                    ...
                    if(!$("#form-comments .stars .starn.star-on").length) {
                        var textError = 'Avalia��o do produto obrigat�ria, d� sua avalia��o por favor';
                    ...
                    'success'  : function (viacepResponse) {
                        ...
                        $.ajax({
                            ...
                            'success' : function (response) {
                                ...
                                if (prazo == 'Prazo de Entrega e Observa��es:'){
